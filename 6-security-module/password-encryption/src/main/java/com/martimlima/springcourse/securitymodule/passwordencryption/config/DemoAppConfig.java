package com.martimlima.springcourse.securitymodule.passwordencryption.config;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages="com.martimlima.springcourse.securitymodule.passwordencryption")
